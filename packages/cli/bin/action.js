...
var createFile = function (componentPath, fileName, componentname) {
    if (
        fs_extra_1["default"].pathExistsSync(
    ...
    var filepath = path_1["default"].resolve(
        __dirname,
        "../template/node/" + fileName + ".temp"
    );
    var res = fs_extra_1["default"].readFileSync(filepath, {
        encoding: "utf-8",
    });
...
var createNode = function () {
    inquirer_1["default"]
        ...
        .then(function (res) {
            var config = require(path_1["default"].resolve(
                process.cwd(),
                "./cilconfig.json"
            ));
